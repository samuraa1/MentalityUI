    ...
    do 
        ...
        Library.Sections.Slider = function(self, Data)
            ...
            function Slider:Set(Value, SkipCallback)
                ...
                if ratio <= 0 then
                    icon.Parent = track
                    icon.AnchorPoint = Vector2New(0, 0.5)
                    icon.Position = UDim2New(0, 0, 0.5, 0)
                else
                    if icon.Parent ~= accent then
                        icon.Parent = accent
                    end
                    if ratio >= 1 then
                        icon.AnchorPoint = Vector2New(1, 0.5)
                        icon.Position = UDim2New(1, -5, 0.5, 0)
                    else
                        icon.AnchorPoint = Vector2New(0.5, 0.5)
                        icon.Position = UDim2New(1, 5, 0.5, 0)
                    end
                end
